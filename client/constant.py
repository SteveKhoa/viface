...
NUMBER_REQUIRED_INITIAL_SAMPLES = int(os.getenv("CLIENT_NUMBER_REQUIRED_INITIAL_SAMPLES"))
...
FEATURE_EXTRACTOR_DNN_MODEL = os.getenv("CLIENT_FEATURE_EXTRACTOR_DNN_MODEL")
FEATURE_EXTRACTOR_FACE_DETECTOR = os.getenv("CLIENT_FEATURE_EXTRACTOR_FACE_DETECTOR")
